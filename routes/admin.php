...
Route::middleware(['web', 'auth', 'team.scope'])->group(function () {
    ...
    Route::prefix('recruitment')->name('recruitment.')->group(function () {
        ...
        // AJAX endpoint untuk pencarian employee (tambahan baru)
        Route::get('contracts/ajax/employees', [ContractController::class, 'getEmployees'])
            ->middleware('permission:contract.create')
            ->name('contracts.getEmployees');
    ...
    Route::prefix('training')->name('training.')->group(function () {
        Route::get('monitoring', function () {
            return view('training.monitoring');
        })->middleware('permission:training.view')
          ->name('monitoring');

        Route::get('principal-approval', function () {
            return view('training.principal-approval');
        })->middleware('permission:training.view')
          ->name('principal-approval');
    });

    // =========================
    // SELF PROFILE (optional - jika ada)
    // =========================

...
Route::middleware(['web', 'auth', 'team.scope'])->group(function () {
    ...
    Route::prefix('training')->name('training.')->group(function () {
        Route::get('monitoring', [TrainingMonitoringController::class, 'index'])->middleware('permission:training.view')->name('monitoring');
        Route::get('principal-approval', [TrainingApprovalController::class, 'index'])->middleware('permission:training.view')->name('principal-approval');
    });

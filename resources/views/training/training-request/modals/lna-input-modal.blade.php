        ...
        @csrf
          ...
          <div class="u-mb-xl">
            ...
            <div class="grid grid-cols-2 gap-x-10 gap-y-2 u-space-lg u-mb-xl">
                <div class="font-bold u-mb-sm">
                    <label class="w-48 font-medium">Unit</label>
                    <input type="text" name="unit" class="u-input">
                </div>
                <div class="font-bold u-mb-sm">
                ...
                <div class="font-bold u-mb-sm">
                    <label class="w-48 font-medium">Fungsi</label>
                    <input type="text" name="fungsi" class="u-input">
                </div>
                <div class="font-bold u-mb-sm">
                    <label class="w-48 font-medium">Kuota</label>

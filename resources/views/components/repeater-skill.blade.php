<div class="repeater-item bg-gray-50 p-6 rounded-2xl mb-6 border border-gray-100 relative hover:shadow-md transition-all">
    ...
    <h4 class="u-block u-text-sm u-font-bold u-mb-sm text-gray-800 mb-6 border-b border-gray-200 pb-2 flex items-center gap-2"><i class="fas fa-tools text-blue-500"></i> Skill / Kompetensi</h4>
    <div class="space-y-4">

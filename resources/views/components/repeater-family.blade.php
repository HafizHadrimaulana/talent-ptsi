<div class="repeater-item bg-gray-50 p-6 rounded-2xl mb-6 border border-gray-100 relative transition-all hover:shadow-sm">
    <button type="button" onclick="removeRow(this)" class="absolute top-6 right-6 text-gray-400 hover:text-red-500 transition-colors"><i class="fas fa-trash-alt"></i></button>
    <h4 class="u-block u-text-sm u-font-bold u-mb-sm text-gray-800 mb-6 border-b border-gray-200 pb-2 flex items-center gap-2"><i class="fas fa-user-friends text-blue-500"></i> Data Keluarga</h4>
    <div class="space-y-4">

...
class RecruitmentRequest extends Model
{
    ...
    protected $fillable = [
        ...
        'ticket_number','budget_source_type','budget_ref','target_start_date','request_type','is_published',
        'description','publish_start_date','publish_end_date','publish_location',
    ];
